...
<i class="fa fa-download" aria-hidden="true"></i> [Latest Ardusub-Raspbian Image](http://img.ardusub.com/ardusub-raspbian.img.gz) *(1.56 GB, Updated 2016-10-04)*
...
These instructions assume you already have a firmware file (ArduSub-v2.px4) from the [firmware repository](http://firmware.ardusub.com/) or that you [compiled yourself](/developer/). Run the commands from the section above to update your `companion` code to the most recent version and then run the following command to update the firmware:
